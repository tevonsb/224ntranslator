...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.h_projection = nn.Linear(2*hidden_size, hidden_size, bias=False) ## UNSURE OF SIZE
        self.c_projection = nn.Linear(2*hidden_size, hidden_size, bias=False) ## UNSURE OF SIZE
        self.att_projection = nn.Linear(2*hidden_size, hidden_size, bias=False) ## UNSURE OF SIZE
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in list(torch.split(Y, 1, 0)):
